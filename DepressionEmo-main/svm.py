...
train_set = read_list_from_jsonl_file('/data/zhentianlong/paper6/DepressionEmo-main/Dataset/train.json')
val_set = read_list_from_jsonl_file('/data/zhentianlong/paper6/DepressionEmo-main/Dataset/val.json')
test_set = read_list_from_jsonl_file('/data/zhentianlong/paper6/DepressionEmo-main/Dataset/test.json')
